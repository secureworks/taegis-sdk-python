...
@dataclass_json
@dataclass(order=True, eq=True, frozen=True)
class SetTenantMappingInput:
    """SetTenantMappingInput."""
    ...
    account_origin: Optional[Union[AccountOrigin, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
            decoder=lambda x: decode_enum(AccountOrigin, x),
            field_name="accountOrigin",
        ),
    )
...
class PermissionCheck:
    ...
    object_: Optional[Union[AuthzObject, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
...
class NewSSOConnectionInput:
    ...
    type_: Optional[Union[SSOConnectionType, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
...
class TenantsQuery:
    ...
    with_mdr_provider_ids: Optional[list[str]] = field(
        default=None, metadata=config(field_name="withMDRProviderIDs")
    )
