...
class ParserInput:
    ...
    type_: Optional[Union[ParserType, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
            decoder=lambda x: decode_enum(ParserType, x),
            field_name="type",
        ),
    )
    format_: Optional[Union[ParserFormatType, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
            decoder=lambda x: decode_enum(ParserFormatType, x),
            field_name="format",
        ),
    )
