...
class EntityContextSingleEntryPoint:
    ...
    id_: Optional[str] = field(default=None, metadata=config(field_name="id"))
    type_: Optional[Union[EntityContextEntryPointType, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
...
class EntityContextOrigin:
    ...
    type_: Optional[Union[EntityContextOriginType, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
...
class EntityContextAddToInput:
    ...
    ids: Optional[list[str]] = field(default=None, metadata=config(field_name="ids"))
    type_: Optional[Union[EntityContextAddToTypeInput, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
...
class EntityContextPivotQLOptions:
    ...
    type_: Optional[Union[EntityContextPivotQLType, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
...
class EntityContextAssociatedEntitiesFilters:
    ...
    filter_: Optional[EntityContextEntityCollectionFilter] = field(
