...
class EventQueryOptions:
    ...
    search_target: Optional[Union[SearchTarget, TaegisEnum]] = field(
        default=None,
        metadata=config(
            metadata={
                "deprecated": True,
            ...
            encoder=encode_enum,
            decoder=lambda x: decode_enum(SearchTarget, x),
...
class EventQueryResults:
    ...
    next_: Optional[str] = field(default=None, metadata=config(field_name="next"))
