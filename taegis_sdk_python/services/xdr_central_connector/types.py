...
class CreateCentralAccessTokenInput:
    ...
    type_: Optional[Union[CentralAccessTokenType, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
...
class IsolateUserDetails:
    ...
    type_: Optional[Union[IsolatedPrincipalType, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
...
class CentralAccessTokenCreatedBy:
    ...
    type_: Optional[Union[CentralAccessTokenCreatedByPrincipal, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
...
class EndpointInstaller:
    ...
    type_: Optional[Union[CixaEndpointType, TaegisEnum]] = field(
        default=None,
        metadata=config(
            encoder=encode_enum,
