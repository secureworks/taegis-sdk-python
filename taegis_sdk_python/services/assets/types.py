...
class SearchAssetsInput:
    ...
    filter_asset_state: Optional[AssetStateFilter] = field(
        default=None, metadata=config(field_name="filter_asset_state")
    )
...
class SearchAssetsPaginationInput:
    ...
    offset: Optional[int] = field(default=None, metadata=config(field_name="offset"))
    limit: Optional[int] = field(default=None, metadata=config(field_name="limit"))
    order_by: Optional[AssetsOrderByInput] = field(
        default=None, metadata=config(field_name="order_by")
    )
    order_direction: Optional[AssetsOrderDirectionInput] = field(
        default=None, metadata=config(field_name="order_direction")
    )
