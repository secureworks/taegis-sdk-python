...
class AggregateAlertsBySeverityInputInput:
    ...
    group_by: Optional[Union[AggregateAlertsBySeverityInput_GroupBy, TaegisEnum]] = (
        field(
            default=None,
            metadata=config(
                encoder=encode_enum,
                decoder=lambda x: decode_enum(
                    AggregateAlertsBySeverityInput_GroupBy, x
                ),
                field_name="group_by",
            ),
        )
...
class AlertsList:
    ...
    list_: Optional[list[Alert2]] = field(
